...
//
//open class AuthApiAsyncClient: ApiClient {
...
//  }
//
//  func getActivationCodes(includeClientSecret: Bool = true, includeClientId: Bool = true) async throws ->
...
//
//    let response = try await request(apiRequest)
//
...
//
//  @discardableResult
//  public func createToken(deviceCode: String) async throws -> AuthProperties? {
...
//
//  @discardableResult
//  func updateToken(refreshToken: String) async throws -> AuthProperties? {
//    var properties: AuthProperties?
//
//    var queryItems: Set<URLQueryItem> = []
//
